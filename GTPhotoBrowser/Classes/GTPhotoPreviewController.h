...
@interface GTPhotoPreviewController : UIViewController

@property (nonatomic, strong) NSArray<GTPhotoModel *> *models;

@property (nonatomic, assign) NSInteger selectIndex; //选中的图片下标

@property (nonatomic, copy) void (^btnBackBlock)(NSArray<GTPhotoModel *> *selectedModels, BOOL isOriginal);
