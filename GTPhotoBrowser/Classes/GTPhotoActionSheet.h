...
@interface GTPhotoActionSheet : UIView


@property (nonatomic, weak) UIViewController *sender;

/**相册框架配置，默认为 [GTPhotoConfiguration defaultPhotoConfiguration]*/
@property (nonatomic, strong, readonly) GTPhotoConfiguration *configuration;
...
/**
 ...
 @warning photos 内对象请调用 GTPhoteDefine 中 GetDictForPreviewPhoto 方法，e.g.: GetDictForPreviewPhoto(image, GTPreviewPhotoTypeUIImage)
 
 @param photos 接收对象 GTPhoteDefine 中 GetDictForPreviewPhoto 生成的字典
