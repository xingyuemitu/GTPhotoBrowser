...
@implementation GTClippingCircle
...
- (id)initWithLayer:(id)layer
{
    ...
    if(self && [layer isKindOfClass:[GTGridLayar class]]){
        self.bgColor   = ((GTGridLayar *)layer).bgColor;
        self.gridColor = ((GTGridLayar *)layer).gridColor;
        self.clippingRect = ((GTGridLayar *)layer).clippingRect;
    }
    return self;
}
...
- (void)setRatio:(GTClipRatio *)ratio
{
    if(ratio != _ratio){
        _ratio = ratio;
    }
